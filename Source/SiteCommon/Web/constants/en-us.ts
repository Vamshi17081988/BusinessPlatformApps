export const EN_US = {
    ...
    APP_INSIGHTS_ERROR: `There is no Application Insights account under your subscription.`,
    APP_INSIGHTS_INSTANCE: `Select Application Insights Instance:`,
    APP_INSIGHTS_CONFIG_SUBTITLE: `Set up a connection to one of your subscription's Application Insights instances so we can bring in your data.`,
    APP_INSIGHTS_CONFIG_TITLE: `Connect to Application Insights`,
    APP_INSIGHTS_CONTINUOUS_EXPORT: `Select Existing Continuous Export Storage Account:`,
    APP_INSIGHTS_CONTINUOUS_EXPORT_ADDING_NEW: `This may take a few moments.`
    APP_INSIGHTS_CONTINUOUS_EXPORT_CONFIG_SUBTITLE: `This solution requires a Continuous Export configuration for your Application Insights telemetry.`,
    APP_INSIGHTS_CONTINUOUS_EXPORT_CONFIG_TITLE: `Configure Continuous Export`,
    APP_INSIGHTS_CONTINUOUS_EXPORT_NOT_FOUND: `We did not find an existing connection. Click next to configure a new storage account.`,
    ...
    AX_FINANCE_INSIGHTS_COLLECTIONS_TEMPLATE_TITLE: `Finance Insights`,
    ...
    INIT_APP_INSIGHTS_PRICING_CALCULATOR_URL: `https://azure.microsoft.com/en-us/pricing/calculator/`,
    INIT_APP_INSIGHTS_PRICING_COST: `By clicking next and deploying the template, you authorize Microsoft to create Azure resources on your subscription and bill based on their respective pricing rates. The approximate base cost of the Azure resources used by this template is [$TBD]. These costs are estimates only and subject to change.`,
    INIT_APP_INSIGHTS_PRICING_URL: `https://github.com/Microsoft/BusinessPlatformApps/blob/dev/Source/Apps/Microsoft/Released/Microsoft-TwitterTemplate/README.md`,
    INIT_APP_INSIGHTS_SUBTITLE: `[Welcome to the application insights solution template.]`,
    INIT_APP_INSIGHTS_TEMPLATE_NAME: `[Dashboards for Application Insights]`,
    ...
    INIT_GETTING_STARTED_APP_INSIGHTS: `Application Insights Instance`,
    ...
    INIT_IOT_CDE_TITLE: `Getting started with Azure IoT Central Analytics`,
